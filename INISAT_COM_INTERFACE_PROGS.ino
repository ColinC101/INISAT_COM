...
// NMEA NMEA NMEA NMEA NMEA NMEA NMEA NMEA NMEA NMEA NMEA NMEA NMEA NMEA NMEA NMEA NMEA NMEA NMEA NMEA NMEA NMEA NMEA NMEA NMEA NMEA NMEA NMEA NMEA NMEA NMEA NMEA NMEA NMEA NMEA NMEA
    ...
    if  (inChar == 'O') {
    Temp_String = Serial1.readStringUntil('@');
    int L = Temp_String.length(); Serial.println(L);
...
if ( millis() - startTime >= INTV ) {
   ...
   if ( (millis() - user_start >= user_intv)&& (udp_Ex==0) ) { user = 0; consConfig = "00000000000000"; chart1 = '0'; chart2 = '0';chart3 = '0';chart4 = '0';chart5 = '0';chart6 = '0';  Serial.println("user deconnected");user_start = millis(); }
...
if (s == "none") {udp_Ex = 0; /*consConfig ="00000000000000";*/} // commande interface ARTH
   ...
   ReplyBuffer = getState() ;}
       ...
       LoraStatus = 1;
      if (loraOk ==1) {digitalWrite(LORA_LED, LoraStatus); Serial.println("... Liaison LORA Activee ...");}// LED LIAISON LORA
      ReplyBuffer = getState() ;}
else if (s == "loraoff") {   // commande interface ARTH + standard
      LoraStatus = 0;
      if (loraOk ==1) {digitalWrite(LORA_LED, LoraStatus); Serial.println("... Liaison LORA Desactivee ...");}// LED LIAISON LORA

 ReplyBuffer = getState() ;}
else if (s == "test") {Serial1.flush(); Serial1.print('A'); autoTesting = 1; Serial.println("A"); ReplyBuffer = getState() ;} // commande interface ARTH
else if (s == "autotest"){Serial1.flush(); Serial1.print('A'); autoTesting = 1; Serial.println("A"); ReplyBuffer = "Config " + s + " lancee ..";}
