...
def initWeb():
    ...
    while True:
        (tcpClientSocket, tcpAddress) = tcpServersocket.accept() #Accept new connection
        _thread.start_new_thread(tcpClientThread, (tcpClientSocket, utime.ticks_ms())) #Start a new thread to handler the new connection
